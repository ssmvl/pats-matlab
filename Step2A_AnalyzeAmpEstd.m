%
% Script for analyzing random walk model data using PATS (Example 1, first
...
for s = 1:simCount
	...
	for r = 1:2
		...
		simData = simRandomWalk(nDataPoints, timeoutMsec, ...
...
clear progText s r simData rcdfAdjRsq cdfAdjRsq;
save(fullfile('data-fitted', 'Step2A_AmpEstd.mat'));
