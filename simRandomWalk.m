function rtMsec = simRandomWalk(numTrials, timeoutMsec, dritfMean, driftSD, noiseSD, rhythmF, rhythmP, rhythmK)
% simRandomWalk generates response times using modified random walk model
%   simulations, with an oscillation embedded in the drift rate
%
% rtMsec = simRandomWalk(numTrials, timeoutMsec, dritfMean, driftSD, noiseSD,
